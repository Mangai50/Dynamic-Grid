...
for (var i = 0; i < productList.length; i++) {
    if (productList[i].isAccessory == false) {
        ...
        h3Element.innerText = productList[i].name;
        detailsDiv.append(h3Element);

        // Product Brand
        var h4Element = document.createElement("h4");
        h4Element.innerText = productList[i].brand;
        detailsDiv.append(h4Element);

        // Product Price
        var h5Element = document.createElement("h5");
        h5Element.innerText = productList[i].price;
        detailsDiv.append(h5Element)
        ...
        var mainDiv = document.createElement("div");
        mainDiv.className = "card";
        accessoriesCards.append(mainDiv);
